...
vacancyRoute.get('/all-vacancies',authMiddleware.auth,hasRole([ERole.APPLICANT,ERole.COMPANY]),vacancyController.getAllVacancy)
vacancyRoute.get('/get-applicant/:id',authMiddleware.auth,hasRole([ERole.COMPANY]),vacancyController.getApplicantsForCompany.bind(vacancyController));

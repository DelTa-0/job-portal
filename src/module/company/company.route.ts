...
companyRouter.get('/get-profile',authMiddleware.auth,hasRole([ERole.COMPANY]),companyController.getProfile.bind(companyController));
companyRouter.post('/forgot-password',companyController.forgetPassword.bind(companyController))

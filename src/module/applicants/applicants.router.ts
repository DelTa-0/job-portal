...
applicantsRouter.post(
  "/create-applicant",
  upload.fields([{ name: "cv" }, { name: "profile" }]),
...
applicantsRouter.post(
  "/apply/:vacancyId",
  authMiddleware.auth,
  hasRole([ERole.APPLICANT]),
  applicantsController.applyVacancy.bind(applicantsController),
);
applicantsRouter.get(
  "/vacancies",
  authMiddleware.auth,
  hasRole([ERole.APPLICANT]),
  applicantsController.getAppliedVacancies.bind(applicantsController),
);
applicantsRouter.get(
  "/get-profile",
  authMiddleware.auth,
  hasRole([ERole.APPLICANT]),
  applicantsController.getProfile,
);
